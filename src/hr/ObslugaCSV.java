		...
		try (Scanner sc = new Scanner(plik)){
			while(sc.hasNextLine()) {
				...
				int id =Integer.parseInt(fragmenty[0]);
	   			 ...
	   			 Employee emp = new Employee(id, fragmenty[1],
	   					 fragmenty[2], fragmenty[3], salary,
	   					 hireDate, fragmenty[6], fragmenty[7],
	   					 fragmenty[8], fragmenty[9], fragmenty[10]);
	   			 list.add(emp);
			}
